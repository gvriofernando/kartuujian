...
<?php
    if (isset($_POST['submitted'])){
        ...
        if ($rec == 1) {   
            ...
            $_SESSION['shakakses'] = $hakakses;
            $_SESSION['ssemester'] = $semesters;
            $_SESSION['snamanyauser'] = $namauser;
            $valid = 1;
        } else {
            $valid = 0;
        }
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
              ...
              <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                  <a href="#" class="d-block">Print Kartu Ujian</a>
                </div>
              </div>
            ...
            <section class="content">
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-10">
                                <h1 class="m-0 text-dark"><center>Selamat Datang di Website Print Kartu Ujian</center></h1>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                </div>
