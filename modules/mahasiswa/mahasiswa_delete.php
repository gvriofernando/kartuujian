  ...
  if (isset($_GET['id']) ) { 
    ...
    if (isset($_POST['submitted'])) {
      ...
      foreach($_POST AS $key => $value) { $_POST[$key] = mysqli_real_escape_string($con,$value); } 
        ...
        echo '<meta http-equiv="refresh" content="2;url=index.php?mod=mahasiswa">'; 
...
<div class="card card-danger">
    <div class="card-header">
        <h3 class="card-title">Formulir Delete Mahasiswa</h3>
    </div>
              <!-- /.card-header -->
              <!-- form start -->
    <form role="form" method="post">
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="tahun_akademik" disabled>
