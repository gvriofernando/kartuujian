<?php
  if(isset($_POST['kirim'])==1){
    $c=" AND username like '%" . $_POST['table_search']. "%'";
  } else {
    $c="";
  }

  $sql = "SELECT * FROM user where hakakses = 'mhs'" . $c;
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Tabel Data Mahasiswa</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
          ...
          <a href="index.php?mod=<?php echo $modname; ?>_new" class="btn btn-s-md btn-success"> + Tambah Baru</a>
            <div class="card-tools">
              <div class="input-group input-group-sm" style="width: 300px;">
               Cari Nama&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;                 
                <input type="text" name="table_search" class="form-control float-right" placeholder="Tulis Username">
        ...
        <table class="table table-head-fixed text-nowrap">
          ...
          <tbody>
            ...
            <tr>
                <td>
                  <div align="center">
                    <a href="index.php?mod=<?php echo $modname; ?>_edit&id=<?php echo $data['username'] ?>">
                      <span class="fa fa-edit" style="font-size:16px">
                      </span>
                    </a>
                    &nbsp;&nbsp;
                    <a href="index.php?mod=<?php echo $modname; ?>_delete&id=<?php echo $data['username'] ?>">
