...
if (isset($_GET['id']) ) { 
  ...
  if (isset($_POST['submitted'])) {
    foreach($_POST AS $key => $value) { $_POST[$key] = mysqli_real_escape_string($con,$value); }
      $sql1 = "DELETE FROM jadwal_ujian WHERE id_jadwal = '$id' ";
      ...
      if($hasilkueri==1) {
        ...
        echo '  <div class="widget-content">
              <div class="alert alert-danger">
                ...
                Maaf data jadwal gagal Dihapus.
              </div>
              </div>';
      }
...
<div class="card card-danger">
    ...
    <form role="form" method="post">
        <div class="card-body">
          ...
          <select class="form-control" name="kodematkul" disabled>
                <?php
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="jenisujian" disabled>
            ...
            <div class="bootstrap-timepicker">
                  <div class="form-group">
                    ...
                    <div class="input-group date" id="timepicker" data-target-input="nearest">
                      <input name = "waktu" type="text" class="form-control datetimepicker-input" data-target="#timepicker" value = "<?php echo $row['waktu']; ?>" readonly/>
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="semester" disabled>
