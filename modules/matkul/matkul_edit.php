	...
	if (isset($_GET['id']) ) { 
		...
		if (isset($_POST['submitted'])) {
			foreach($_POST AS $key => $value) { $_POST[$key] = mysqli_real_escape_string($con,$value); } 
				$sql = "UPDATE matkul set 	nama_matkul         ='{$_POST['nama_matkul']}',
				...
				if($hasilkueri==1) {
						...
						echo '	<div class="widget-content">
									<div class="alert alert-danger">
										...
										Maaf data mata kuliah gagal diupdate.
									</div>
			                  	</div>';
					} 
...
<div class="card card-warning">
    <div class="card-header">
        <h3 class="card-title">Formulir Edit Mata Kuliah</h3>
    </div>
              <!-- /.card-header -->
              <!-- form start -->
